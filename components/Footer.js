      ...
      <div className="grid md:grid-cols-4 md:gap-8 grid-cols-2">
        <div className="mt-12 md:mt-0">
          ...
          <ul role="list" className="mt-4 space-y-4">
            <li>
              <p href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Pricing </p>
            </li>
            <li>
              <p href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Documentation </p>
            </li>
            <li>
              <p href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Guides </p>
            </li>
            <li>
              <p href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> API Status </p>
            </li>
          </ul>
        </div>
        <div className="mt-12 md:mt-0">
    ...
    <div className="px-5 py-12 mx-auto bg-gray-50  sm:px-6 md:flex md:items-center md:justify-between lg:px-20">
      ...
      <div className="mt-8 md:mt-0 md:order-1">
        <span className="mt-2 text-sm font-light text-gray-500">
           Copyright © 2017-2022 
          <p href="#" className="mx-2 text-wickedblue hover:text-gray-500" rel="noopener noreferrer">Storyblok GmbH</p>.
        </span>
      </div>
    </div>
  </footer>
